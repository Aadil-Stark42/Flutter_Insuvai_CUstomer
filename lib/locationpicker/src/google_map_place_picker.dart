...
import 'package:insuvaicustomer/locationpicker/src/components/animated_pin.dart';
import 'package:insuvaicustomer/locationpicker/src/components/floating_card.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              children: [
                Image(
                  image: AssetImage("${IMAGE_PATH}location.png"),
                  width: 22,
                  height: 22,
                  color: MainColor,
                ),
