...
import 'package:insuvaicustomer/ui/home/FavoriteScreen.dart';
import 'package:insuvaicustomer/ui/home/NotificationScreen.dart';
import 'package:insuvaicustomer/ui/shop/ShopDetailsScreen.dart';
import 'package:insuvaicustomer/ui/shop/ShopListScreen.dart';
...
class MyHomeSubScreenState extends State<MyHomeSubScreen> {
  ...
  Widget ImageSlideView(ShopBanners element) {
    return FadeInImage(
        fit: BoxFit.fill,
        placeholder: AssetImage(IMAGE_PATH + "no_image_placeholder.png"),
    ...
    return Container(
      child: Container(
        ...
        child: ClipRRect(
            ...
            child: FadeInImage(
                placeholder:
                    AssetImage(IMAGE_PATH + "no_image_placeholder.png"),
                image: NetworkImage(element.image.toString()))),
      ),
    );
  }
                          ...
                          Positioned(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    DashBoardData.notificationCount.toString(),
                                    style: TextStyle(
                                      color: BlackColor,
                                      fontSize: 8,
                                    ),
